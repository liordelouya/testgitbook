---
description: Connect Gmail to pull user, group, and mail metadata into Lema.
layout:
  width: default
  title:
    visible: true
...
You can reuse the same service account — skip to Step 3 to add the Gmail-specific scopes and enable the Gmail API.
{% endhint %}
