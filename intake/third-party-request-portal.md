...
{% hint style="info" %}
**The intake form is your first IRQ signal.**
The Security, Privacy & Resiliency Assessment section is synced directly with your IRQ template. Answers submitted by the business user automatically pre-populate the vendor's Inherent Risk Profile — so your risk scoring starts with real business context, not guesswork.
